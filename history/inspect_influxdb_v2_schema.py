...
"""
    ...
    try:
        ...
        if measurements:
            ...
            k8s_measurements = [
                m for m in measurements if "kubernetes" in m or "kube" in m
            ]
...
def inspect_measurement_schema(
    client, measurement: str, namespace: str, time_range: str
):
    ...
    try:
        ...
        for measurement in measurements[:3]:  # Inspect first 3
            if measurement != jupyterhub_measurement:
                inspect_measurement_schema(
                    client, measurement, args.namespace, args.time_range
                )
